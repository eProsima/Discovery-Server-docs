...
qthelp:
	...
	@echo "# qcollectiongenerator $(BUILDDIR)/qthelp/sphynx-demo.qhcp"
	@echo "To view the help file:"
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/sphynx-demo.qhc"
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/sphynx-demo"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/sphynx-demo"
	@echo "# devhelp"
...
.PHONY: pdf
pdf:
	$(SPHINXBUILD) -d pdf $(ALLSPHINXOPTS) $(BUILDDIR)/pdf
	@echo
